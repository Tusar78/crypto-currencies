        ...
        <section className="section">
          ...
          <div className="coin-details">
            <div className="coin-details__desc">
              ...
              <div className="coin-details__description">
                <p
                  className="coin-details__single-info"
                  title={description?.en.length > 600 ? description?.en : ""}
                >
                  {description?.en.length > 600
                    ? description?.en.substr(0, 600) + "..."
                    : description?.en}
                </p>
              </div>
            </div>
